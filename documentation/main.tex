...
\begin{document}
    ...
    \keywords{Image Colourisation, Neural networks, AutoEncoders, cGAN} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
    ...
    \input{sections/results_discussions}
    \input{sections/concolusions}
    %TC:ignore 
